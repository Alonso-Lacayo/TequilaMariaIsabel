        ...
        >
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-serif text-primary">Our Premium Tequila</h2>
              <div className="relative h-96 rounded-lg overflow-hidden">
                <Image
                  src="/tequila.jpg"
                  alt="María Isabel Tequila bottle showcase"
                  fill
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative h-48 rounded-lg overflow-hidden">
                  <Image
                    src="/pool-two.jpg"
                    alt="María Isabel Tequila by the pool"
                    fill
                    className="object-cover"
                  />
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-secondary font-serif">
                  Each bottle of María Isabel Tequila is crafted with precision and care, 
                  representing the perfect harmony of tradition and excellence. 
            ...
            {/* Order Form */}
            <div>
              <h1 className="text-4xl font-serif text-primary mb-8">Place Your Order</h1>
